    	...
    	<div class="row">
    		...
    		<div class="col-sm-4">
	    		<form action="" method="post">
		    		Username : <input type="text" id="username" name="username" required="" class="form-control" value="<?php if(isset($username)){ echo $username; } ?>">
		    		Password : <input type="password" id="pass" name="password" required="" class="form-control" value="<?php if(isset($password)){ echo $password; } ?>">
		    		<br>
		    		<input class="btn btn-outline-info" type="submit" name="login" id="login" value="Login">
	    		</form>
    		</div>
    		<div class="col-sm-4"></div>
    	</div>
